<template>
  <div class="agreement" v-if="agreementShow">
    <span class="rules_close_btn" @click="close">
      <img src="../assets/img/close_btn.png" alt="" />
    </span>
    <div class="agreement_content">
      <h1>一汽丰田顾客个人信息保护基本方针</h1>
      <p>
      ...
      <h4>2)“一汽丰田”将在取得顾客的同意后，取得其个人信息。</h4>
      ...
      <p>
        ③
        发送与“一汽丰田”的产品、服务、宣传活动（包括但不限于汽车、保险等）相关的信息或通知；（但在未取得顾客同意的情况下，我们不会发送商业性目的的上述信息或通知）
      </p>
      <p>
